...
## Create RStudio Project in *r3-exercises*
...
## Create `index.Rmd` in *r3-exercises*
...
## Setup Github Pages website for *r3-exercises*
...
You now have *write* permissions on this repo. Please proceed with previous steps above to **Create Github RStudio Project**, except this time using `https://github.com/USER/r3-train.git` as the URL. Be sure to replace USER with your Github username.
...
## **Sandbox** *r3-exercises* with Rmd website with `branch` & `merge`
